...
Promising methods that need a small input, protocol, or evidence delta are tracked in [NEAR_COMPATIBLE.md](NEAR_COMPATIBLE.md). Entries there are not runnable or approved.
...
| --- | --- | --- | --- |
| [Heart-rate fragmentation](heart-rate-fragmentation/) | E0 author-reference reproduction; study only | Brainstem lacks adjudicated normal-beat labels; source bounds conflict; reliable window and detector transfer unresolved | Governed beat-labelling and artifact study before any runtime review |
| [Standing heart-rate response](standing-heart-rate-response/) | E0 generated methods candidate; eligible for protected runtime review; live runtime disabled | Heart-rate-only descriptor; no beat-to-beat blood pressure, Brainstem reference, or clinical validation | Protected generated proof and independent scientific/privacy/security review |
| [Guided-breathing response](guided-breathing-response/) | E0 generated methods candidate; eligible for protected runtime review; live runtime disabled | Exact protocol-matched time-domain descriptors; no respiratory adherence, treatment, optimal rate, or clinical interpretation | Protected generated proof and independent scientific/privacy/security review |
| [Six-rate breathing response](six-rate-breathing-response/) | E0 generated methods candidate; runtime review held | Exact six-rate curve and all-ties rule; no versioned full-curve upload, measured adherence/respiration, or repeatability result | Cross-platform producer proof, repeated-session methods study, then independent review |
...
| [Overnight heart-rate change](overnight-heart-rate-change/) | E1 public reproduction; protected runtime pending | Brainstem translation is descriptive and device calibration remains absent | Protected generated proof and independent scientific/privacy/security review |
| [Resting HRV repeatability](resting-hrv-repeatability/) | E0 generated methods candidate; protected runtime pending | Generated cohort only; controlled laboratory protocol is not reproduced | Protected generated proof and independent scientific/privacy/security review |
